 ...
 *   Template variables.
 */
function kickstarter_preprocess_html(&$vars) {
...
function kickstarter_css_alter(&$css) {
 ...
 */
function kickstarter_breadcrumb($variables) {
 ...
 * @ingroup themeable
 */
function kickstarter_menu_link(array $variables) {
